                                            ...
                                            >
                                                ...
                                                <div className="p-4">
                                                    ...
                                                    <div className="flex items-center gap-1.5 mb-2">
                                                        {product.category && (
                                                            <span className="inline-flex items-center px-2 py-0.5 bg-purple-50 text-purple text-[10px] font-medium rounded-md truncate max-w-[80px]">
                                                                {product.category.name}
                                                            </span>
                                                        )}
                                                        {product.supplier && (
                                                            <span className="inline-flex items-center px-2 py-0.5 bg-blue-50 text-primary text-[10px] font-medium rounded-md truncate max-w-[80px]">
